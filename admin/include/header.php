...
if (isset($_SESSION["message"])) {
  # code...
  // show this html
  echo '<div class="ms-auto mt-2 alert alert-success alert-dismissible fade show" role="alert">
...
if (isset($_SESSION["message_error"])) {
  # code...
  // show this html
  echo '<div class="ms-auto mt-2 alert alert-danger alert-dismissible fade show" role="alert">
  <svg class="bi flex-shrink-0 me-2" width="24" height="24" role="img" aria-label="Success:"><use xlink:href="#check-circle-fill"/></svg>
